...
import codingio.northwind.entities.concretes.Category;
...
public interface ProductDao extends JpaRepository<Product,Integer> {
    ...
    @Query("Select new codingio.northwind.entities.dtos.ProductWithCategoryDto(p.id, p.productName, c.categoryName) " +
